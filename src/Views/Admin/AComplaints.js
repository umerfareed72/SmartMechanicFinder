...
class AComplaints extends Component {
  state = {};
  render() {
    return (
      <body
            ...
            >
              <Col className="col-sm-12">
                <Col className="Aligncenter">
                  <h4 className="heading4white orange">Complaints</h4>
                </Col>
                <Col className="col-sm-12">
                  <Col className="Aligncenter">
                    ...
                    <div class="card-body info-card social-about">
                      ...
                      >
                        <h3 className="heading2">
                          <u className="ub">Complaints from (User)</u>
                        </h3>
                      </Col>{" "}
                      <div class="card">
                      ...
                      >
                        <h3 className="heading2">
                          <u className="ub">Complaints from (Mechanics)</u>
                        </h3>
                      </Col>{" "}
                      <div class="card">
                        <div class="card-header">Complaints</div>
